...
export default function ProductDetail  ({productData})  {
    ...
    return(
       ...
       <h1 className="card-title m-3">{productData.name}</h1>
        ...
        <div id="carouselExampleControls" className="carousel slide w-50 h-50 m-5" data-bs-ride="carousel">
  <div className="carousel-inner m-3">
    <div className="carousel-item active">
      <img src={productData.img} className="d-block w-100 " alt="..."/>
    </div>
    <div className="carousel-item">
      <img src={productData.img2} className="d-block w-100 " alt="..."/>
    </div>
    <div className="carousel-item">
      <img src={productData.img3} className="d-block  w-100 " alt="..."/>
    </div>
  </div>
